...
export default function CartPage() {
  ...
  const storeCode =
    search.get("storeCode") || ""

  const table =
    Number(search.get("table") || 0)
  ...
  const [serviceFeeValue, setServiceFeeValue] =
    useState(0)
  ...
  const payNow = async () => {
    if (businessLoading) {
      alert(
        "Checking restaurant payment status. Please try again.",
      )
      return
    }
          ...
          <>
            ...
            {business?.paymentsReady === false && (
              <div className="payment-warning">
                ...
                <div className="payment-warning-sub">
                  {business?.paymentMessage ||
